...
jobs:
    ...
    - name: Trigger Gemini AI Analysis
      ...
      with:
        script: |
          ...
          console.log('✅ Gemini AI analysis workflow triggered');
          console.log('🔗 Analysis will appear as a separate workflow run');

    - name: Add AI Analysis Notice
      run: |
        echo "## 🤖 AI Analysis Initiated" >> $GITHUB_STEP_SUMMARY
        ...
        echo "" >> $GITHUB_STEP_SUMMARY
        echo "📊 **Analysis Focus**: CI integration impact and code quality" >> $GITHUB_STEP_SUMMARY
  ...
  ci-summary:
    ...
    - name: Generate CI Summary
      run: |
        echo "## 🚀 CI Framework Results" >> $GITHUB_STEP_SUMMARY
        echo "" >> $GITHUB_STEP_SUMMARY
