...
class DependencyFixWorkflow:
    ...
    def __init__(self, working_directory: str = ".", config_path: str | None = None):
        """
    ...
    def analyze_output(self, output: str) -> dict[str, Any] | None:
        """
    ...
    def _verify_pixi_install(self) -> tuple[bool, str]:
        ...
        result = self.command_executor.execute(
            "pixi info", working_directory=str(self.working_directory)
        )
