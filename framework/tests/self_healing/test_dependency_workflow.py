...
class TestDependencyWorkflow:
    ...
    def test_execute_workflow_pixi_install(self):
        ...
        with patch.object(self.workflow.command_executor, 'execute', return_value=mock_result):
            with patch.object(self.workflow.dependency_engine.command_executor, 'execute', return_value=mock_result):
                # Create test files
